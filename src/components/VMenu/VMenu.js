...
export default {
  ...
  mixins: [Activator, Dependent, Delayable, Detachable, Generators, Keyable, Menuable, Position, Returnable, Toggleable],
  props: {
    auto: Boolean,
    closeOnClick: {
      type: Boolean,
  ...
  computed: {
    ...
    calculatedMinWidth () {
      ...
      const minWidth = this.dimensions.activator.width + this.nudgeWidth + (this.auto ? 16 : 0)
