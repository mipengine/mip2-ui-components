...
<mip-v-dialog m-bind:value.sync="dialog3" fullscreen hide-overlay transition="dialog-bottom-transition">
  <mip-v-btn slot="activator" color="primary" dark>Open Dialog</mip-v-btn>
  <div class="v-card">
    <mip-v-toolbar dark color="primary">
      <mip-v-btn icon dark on="tap:MIP.setData({ dialog3: false })">
        <mip-v-icon>close</mip-v-icon>
      </mip-v-btn>
      <mip-v-toolbar-title>Settings</mip-v-toolbar-title>
      <mip-v-spacer></mip-v-spacer>
      <mip-v-toolbar-items>
        <mip-v-btn dark flat on="tap:MIP.setData({ dialog3: false })">Save</mip-v-btn>
      </mip-v-toolbar-items>
    </mip-v-toolbar>
...
<mip-v-dialog m-bind:value.sync="dialog4" persistent max-width="500px">
  <mip-v-btn slot="activator" color="primary" dark>Open Dialog</mip-v-btn>
  <mip-v-card>
    <mip-v-card-title>
    ...
    <mip-v-card-actions>
      <mip-v-spacer></mip-v-spacer>
      <mip-v-btn color="blue darken-1" flat on="tap:MIP.setData({ dialog4: false })">Close</mip-v-btn>
      <mip-v-btn color="blue darken-1" flat on="tap:MIP.setData({ dialog4: false })">Save</mip-v-btn>
    </mip-v-card-actions>
  </mip-v-card>
</mip-v-dialog>
```
...
<mip-v-dialog m-bind:value.sync="dialog5" scrollable max-width="300px">
  <mip-v-btn slot="activator" color="primary" dark>Open Dialog</mip-v-btn>
  <div class="v-card">
    <div class="v-card__title">Select Country</div>
    <mip-v-divider></mip-v-divider>
    <div class="v-card__text" style="height: 300px;">
      <mip-v-radio-group m-bind:value.sync="dialogm1" column>
        <mip-v-radio label="Bahamas, The" value="bahamas"></mip-v-radio>
    ...
    <div class="v-card__actions">
      <mip-v-btn color="blue darken-1" flat on="tap:MIP.setData({ dialog5: false })">Close</mip-v-btn>
      <mip-v-btn color="blue darken-1" flat on="tap:MIP.setData({ dialog5: false })">Save</mip-v-btn>
    </div>
  </div>
</mip-v-dialog>
```
...
<mip-v-dialog m-bind:value.sync="dialog6" width="600px">
  <mip-v-btn slot="activator" color="primary" dark>Open Dialog</mip-v-btn>
  <mip-v-card>
    <mip-v-card-title>
    ...
    <mip-v-card-actions>
      <mip-v-spacer></mip-v-spacer>
      <mip-v-btn color="green darken-1" flat="flat" on="tap:MIP.setData({ dialog6: false })">Disagree</mip-v-btn>
      <mip-v-btn color="green darken-1" flat="flat" on="tap:MIP.setData({ dialog6: false })">Agree</mip-v-btn>
    </mip-v-card-actions>
  </mip-v-card>
</mip-v-dialog>
```
...
<mip-v-dialog m-bind:value.sync="dialog7" hide-overlay persistent width="300">
  <mip-v-btn slot="activator" m-bind:disabled="dialog7" m-bind:loading="dialog7" class="white--text" color="purple darken-2" on="tap:MIP.setData({ dialog7: true })">
    Start loading
  </mip-v-btn>
