...
export default {
    ...
    computed: {
        isAllowedHourCb() {
            ...
            return val => {
                return val >= minHour * 1 && val <= maxHour * 1 && (!this.allowedHours || this.allowedHours(val));
            };
        },
        isAllowedMinuteCb() {
            ...
            return val => {
                ...
                return time >= minTime && time <= maxTime && isHourAllowed && (!this.allowedMinutes || this.allowedMinutes(val));
            };
        },
        isAmPm() {
    ...
    methods: {
        ...
        firstAllowed(type, value) {
            ...
            // TODO: clean up
            const range = type === 'minute' ? rangeMinutes : this.isAmPm ? value < 12 ? rangeHours12am : rangeHours12pm : rangeHours24;
