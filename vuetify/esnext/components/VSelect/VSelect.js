...
export default {
    ...
    extends: VTextField,
    mixins: [fakeVMenu, fakeMenuable, Comparable, Filterable],
    props: {
        appendIcon: {
            type: String,
    ...
    methods: {
        ...
        genCommaSelection(item, index, last) {
            ...
            const isDisabled = this.disabled || this.readonly || this.getDisabled(item);
            const classes = index === this.selectedIndex ? this.addTextColorClassChecks() : {};
        ...
        genDefaultSlot() {
            ...
            const activator = this.genSelectSlot([this.genLabel(), this.prefix ? this.genAffix('prefix') : null, selections, this.suffix ? this.genAffix('suffix') : null, this.genClearIcon(), this.genIconSlot()]);
